      ...
      <div class="cdp-form">
        <Form ref="formRef" :model="AppliForm" label-position="right" :label-width="100">
          <Row style="margin-bottom: 10px" :gutter="10">
            <Col span="4">
              <Input v-model="AppliForm.userName" class="cdp-input" placeholder="用户名"></Input>
            </Col>
            <Col span="4">
              <Input v-model="AppliForm.neakName" class="cdp-input" placeholder="昵称"></Input>
            </Col>
            <Col span="4">
              <Input v-model="AppliForm.phone" class="cdp-input" placeholder="手机号"></Input>
            </Col>
            <Col span="4">
