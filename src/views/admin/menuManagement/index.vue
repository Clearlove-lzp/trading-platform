      ...
      <div class="cdp-form">
        <Form ref="formRef" :model="AppliForm" label-position="right" :label-width="100">
          <Row style="margin-bottom: 10px" :gutter="10">
            <Col span="5">
              <Input v-model="AppliForm.userName" class="cdp-input" placeholder="菜单名"></Input>
            </Col>
            <Col span="5">
              <Input v-model="AppliForm.roleId" class="cdp-input" placeholder="菜单唯一标识"></Input>
            </Col>
            <Col span="5">
      ...
      <div class="cdp-table">
        <i-table border :loading="loading" size="small" stripe :columns="columns" :data="datalist">
          ...
          <template #action="{ row, index }">
            <Button type="warning" size="small" style="margin-right: 5px" @click="addFunc(row)">编辑</Button>
