  ...
  <div class="login" :style="'background-image:url('+ Background +');'">
    <Form ref="loginFormRef" :model="loginForm" :rules="loginRules" label-position="left" label-width="0px" class="login-form">
      ...
      <div class="button-container">
        <Button :loading="loading" type="primary" style="width:30%;margin-right: 20px" @click.native.prevent="handleLogin">
          <span v-if="!loading">登 录</span>
          <span v-else>登 录 中...</span>
        </Button>
        <Button type="warning" style="width:30%;" @click.native.prevent="handleRegister">去注册</Button>
      </div>
    </Form>
  </div>
</template>
